...
const emptyInitialState = {
  ...
  leaderboard: {
    currentZone: "Hyderabad Central Hub (Zone 1 - Hitec City / Madhapur)",
    topPerformers: [],
    userStats: {
      rank: 1,
      ordersCompleted: 0,
...
export function DataProvider({ children }) {
    ...
    try {
      ...
      setData((prev) => {
        ...
        next.executives = (execs || []).map((e) => ({
          ...
          zone: e.zone || "Hyderabad Central Hub (Zone 1 - Hitec City / Madhapur)",
          dob: e.dob,
  ...
  const addExecutive = (execData) => {
    ...
    const newExecutive = {
      ...
      city: execData.city || "Hyderabad",
      zone: execData.zone || "Hyderabad Central Hub (Zone 1 - Hitec City / Madhapur)",
  ...
  const addOrder = (orderData) => {
    const newOrder = {
      ...
      dropArea: orderData.dropArea || "Madhapur, Hyderabad",
      pickupArea: orderData.pickupArea || "Hyderabad Central Hub",
